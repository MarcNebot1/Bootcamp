...
function reproducirSonido(event) {
    var sonidoId = event.target.getAttribute('data-sound'); // Obtener el id del sonido
...
document.addEventListener('keydown', function (event) {
    var sonidoId = keyToSound[event.key]; // Obtener el sonido asociado a la tecla presionada
